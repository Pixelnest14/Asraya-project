...
export const marketplaceItems = [
  ...
  { id: 2, title: 'Sofa Set for Rent', description: 'Comfortable 3-seater sofa, available for monthly rent.', price: 'Rs 1,500/month', seller: 'Anil (B-201)', image: '/images/1721997380962.png', dataAiHint: "sofa couch" },
