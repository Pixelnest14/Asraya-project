...
>(
  (
    ...
    return (
       <aside
        ref={ref}
        className={cn("hidden md:flex flex-col h-svh text-sidebar-foreground bg-sidebar border-r transition-[width] duration-300 ease-in-out", 
