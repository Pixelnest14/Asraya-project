  ...
  (
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Contains the main navigation links for the application.</SheetDescription>
            </SheetHeader>
    ...
    return (
      <aside
        ref={ref}
        className={cn(
            "group peer hidden md:flex flex-col text-sidebar-foreground bg-sidebar border-r transition-[width] duration-300 ease-in-out", 
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      className={cn(
        "flex-1 flex flex-col bg-background transition-[margin-left] duration-300 ease-in-out",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        state === 'collapsed' && "mx-auto size-8 p-0",
